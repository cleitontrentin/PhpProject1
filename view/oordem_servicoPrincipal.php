                <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Ordem_Servico</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                        <div class="panel-body" id="ListaFuncionario" name="ListaOrdem_servico">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-edit fa-fw"></i> Cadastro de Ordem de Servico
                        </div>
                        <!-- /.panel-heading -->
